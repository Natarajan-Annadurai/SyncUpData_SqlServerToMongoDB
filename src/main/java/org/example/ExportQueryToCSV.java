...
public class ExportQueryToCSV {
    public void generateCSVFile() {
        ...
        String outputFile = "D://MahilMartProductsData/Mahilmart_UpdatedData_" + timestamp + ".csv";
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password);
            ...
            JobLogger.success(
                    "CSV_EXPORT",
                    "CSV generated successfully. File=" + outputFile
            );

        } catch (SQLException | IOException e) {
            e.printStackTrace();
            JobLogger.failure("CSV_EXPORT", e);
        }
    }
}
